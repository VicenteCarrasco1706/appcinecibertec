...
public interface CarteleraCineSpRepository extends JpaRepository<CarteleraCineSp, Integer>{
	...
	public List<CarteleraCineSp> listarCarteleraxEstado(@Param("estado") Integer estado);
}
